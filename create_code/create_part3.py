...
with open('backend/requirements.txt', 'a') as f:
    f.write('gitpython==3.1.43\nradon==6.0.1\n')

repo_analyzer_content = """import os
import ast
import shutil
import tempfile
...
with open('backend/app/services/repo_analyzer.py', 'w') as f:
    f.write(repo_analyzer_content)

test_repo_analyzer_content = """import os
import tempfile
import pytest
from pathlib import Path
...
with open('backend/tests/test_repo_analyzer.py', 'w') as f:
    f.write(test_repo_analyzer_content)
...
async def analyze_repo_locally(request: RepoURLRequest):
    ...
    return result
"""
with open('backend/app/routes/repos.py', 'w') as f:
    f.write(routes_content)

print("Part 3 files generated.")
